...
```bash
pnpm --filter @dhyunbot/web add @react-sigma/core graphology graphology-communities-louvain
pnpm --filter @dhyunbot/web add -D @types/graphology-communities-louvain
```
