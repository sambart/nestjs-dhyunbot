...
| `hhiThreshold` | `decimal(3,2)` | NOT NULL | `0.30` | 관계 다양성 기준: HHI 편중도 경고 임계값 (0.00~1.00) |
| `minPeerCount` | `int` | NOT NULL | `3` | 관계 다양성 기준: 최소 교류 인원 수 |
| `badgeActivityTopPercent` | `int` | NOT NULL | `10` | 활동왕 뱃지: 상위 N% (1~100) |
| `badgeSocialHhiMax` | `decimal(3,2)` | NOT NULL | `0.25` | 사교왕 뱃지: HHI 상한 (0.00~1.00) |
...
👥 **관계 다양성**
교류 인원: 12명 | HHI: 0.180 (낮을수록 다양)
주요 교류: 유저A (11시간, 22.0%), 유저B (9시간, 18.0%), 유저C (7시간, 14.0%)
✅ 관계 다양성: HHI 0.180 (기준: HHI 0.3 이하)
✅ 교류 인원: 12명 (기준: 3명 이상)
...
📋 **뱃지 달성 가이드**
🌐 사교왕 — HHI 0.25 이하 & 교류 5명 이상 (HHI 0.180, 12명)
